                ...
                <div className="facility-form">
                    ...
                    <div className="facility-address-group form-group">
                        ...
                        <div className="facility-inline-address">
                            <input name="city" className="form-control city-name" placeholder="Latitude..." value={facilityCity} type="text" onChange={e => setFacilityCity(e.target.value)} required />
                            <input name="state" className="form-control state-name" placeholder="Longitude..." value={facilityState} type="text" onChange={e => setFacilityState(e.target.value)} required />
